...
List<QuestionModel> questions = [
  ...
  QuestionModel("Which of these functions contain the code which houses the widgets of your app?", {
    "debug()": false,
    "runApp()": false,
    "random()": false,
    "build()": true,
  ...
  QuestionModel("Which of the following widgets used for repeating the content ?", {
    "Expanded": false,
    "ListView": true,
    "Stack": false,
    "Scaffold": false,
  ...
  QuestionModel("Flutter is mainly optimized for _________ that can run on both Android and iOS platforms.", {
    "2D mobile apps":true ,
    "Desktop only": false,
    " Tablet only": false,
  ...
  QuestionModel(
      " _________ command is used to compile the release mode.", {
